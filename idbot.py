...
REQUIRED_CHANNEL_ID = -1002387714877   # ✅ Updated with actual channel ID
...
class UserData:
    ...
    def set_channel_owner(self, channel_id, user_id):
        ...
        self.save()
    # ---------- Channel & Group storage (auto-update) ----------
...
def save_group_or_channel(message):
    ...
    if chat_type in ["group", "supergroup"]:
        ...
        if not owner_id:
            bot.reply_to(message, "❌ Please add me as admin to this channel first.\nThen try again.", parse_mode="Markdown")
            return
        cid = message.chat.id
...
# ---------- SHOW CHANNEL ID WITH EXISTENCE CHECK ----------
...
# ---------- SHOW GROUP ID WITH EXISTENCE CHECK ----------
...
if __name__ == "__main__":
    print("🚀 Bot started. New token and channel ID updated.")
